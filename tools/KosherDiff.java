// Cross-engine oracle generator (ADR core-domain/0003/0008, /0017). Uses KosherJava (an INDEPENDENT
// zmanim engine; LGPL; build/test oracle ONLY — never shipped, never on the correctness path) to emit
// sea-level sunrise/sunset (NOAA calculator, zenith 90.833° = geometric sun-center at −0.8333°) over a
// fixed grid, as `lat,lon,date,sunrise_millis,sunset_millis`. The committed output
// (tests/fixtures/kosherjava_vectors.csv) is consumed by tests/cross_engine.rs.
//
...
public class KosherDiff {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("name,lat,lon,date,sunrise_millis,sunset_millis");
